...
// import { exportExcel } from "@/app/dashboard/utils/exportExcel";
// import { exportPDF } from "@/app/dashboard/utils/exportPDF";
...
//           <h2 className="text-lg font-bold">{caption||title}</h2>
//           <Button
//             variant="ghost"
//             onClick={onClose}
...
//         {/* CONTENT */}
//         <div className="overflow-auto p-4 flex-1" id="preview-table">
...
//           <Button
//             onClick={() => exportPDF(title, "preview-table")}
