...
export const studentColumns = (
  ...
  { key: "guardianName", label: "Guardian Name", exportable: true },
  { key: "gradeName", label: "Grade" ,exportable: true},
  { key: "sectionName", label: "Section", exportable: true },
  { key: "rollNo", label: "Roll No", exportable: true },
  { key: "gender", label: "Gender", exportable: true },
  { key: "bloodGroup", label: "Blood Group", exportable: true },
  { key: "dateOfBirth", label: "Date of Birth", exportable: true },
  { key: "address", label: "Address", exportable: true },
  { key: "guardianContact", label: "Guardian Contact", exportable: true },
  {
    key: "actions",
    label: "Actions",
    exportable: false,
